...
THIRD_MSG_COMBINED = (
    ...
    "> أمامك **6 ساعات** فقط لإنهاء الاختبار كاملاً\n\n"
    "---\n\n"
    ...
    "---\n\n"
    "## 📤 التسليم\n\n"
    "- عندما تنتهي **قبل انتهاء الوقت**، سلّم عملك عبر **رابط Google Drive** يحتوي على ملفين:\n"
    "  - ملف صور الاختبار بعد التبييض فقط\n\n"
    "  - ملف صور الاختبار بعد تحريرها.\n\n"
    "**يرجى التأكد من رفع الملفين بشكل منفصل داخل مجلد درايف واحد! أي بمعنى رابط واحد.**\n\n"
    "**بالتوفيق!** 🍀\n\n"
    "---\n\n"
    "-# ملاحظة: أي سؤال أو استفسار بخصوص الاختبار اسأل في التكت وانتظرني أو انتظر قدوم الإدارة"
)
